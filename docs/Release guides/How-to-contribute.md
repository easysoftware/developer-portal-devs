...
> In case of integrating RYS into the platform, there should be prepared MR in the platform repository where you should update the version that is compatible with the given platform version.
